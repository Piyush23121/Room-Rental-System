...
function RegisterLandlord(){
    ...
    const handleSubmit =async (e) => {
        ...
        if (noErrors) {
            try {
                await  registerService.registerLandlord(formValues);
                    ...
                    <div className="card">
                        ...
                        <div className="card-body">
                            <form onSubmit={handleSubmit}>
                                <h2 className="mb-4">Landlord Form</h2>
                                <div className="mb-3">
                                ...
                                <div className="mb-3">
                                    <input type="text" name="emailId" className="form-control" placeholder="Email" value={formValues.emailId} onChange={handleChange} />
